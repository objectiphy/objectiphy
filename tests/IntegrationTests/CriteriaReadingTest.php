...
//        $this->assertEquals(6, $this->objectRepository->countBy($query));
    ...
    protected function doAggregateFunctionTests()
    {
        ...
        $this->objectRepository->setClassName(TestParent::class);
        $criteria = QB::create()->where('totalWeightOfPets', '>', 1000)->buildSelectQuery();
        ...
        $this->objectRepository->setClassName(TestPolicy::class);
        $criteria = QB::create()->having('COUNT(%vehicle.wheels.id%)', '>', 4)->buildSelectQuery(); //(5 wheels incl steering wheel!)
        ...
        $this->objectRepository->setClassName(TestParent::class);
        $criteria = QB::create()->having('COUNT(%pets.id%)', QB::LTE, 4)->buildSelectQuery();
