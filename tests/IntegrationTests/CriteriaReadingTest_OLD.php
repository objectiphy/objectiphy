...
//        ]);
        ...
        $this->assertEquals(3, array_keys($policies3)[1]);
        $this->assertEquals(20, array_keys($policies3)[3]);
    ...
    protected function doNestedObjectTests()
    {
        ...
        $this->objectRepository->setEntityClassName(TestEmployee::class);
        ...
        $this->objectRepository->setEntityClassName(TestSecurityPass::class);
    ...
    {
        //You can easily get the actual SQL used with params resolved, ready to copy/paste
